...
// HomeIcon changed by introducing optional 'className' parameter
...
// new icons for updates related to stripe integration
export const CreditCardIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M1 3.5C1 2.67157 1.67157 2 2.5 2H13.5C14.3284 2 15 2.67157 15 3.5V12.5C15 13.3284 14.3284 14 13.5 14H2.5C1.67157 14 1 13.3284 1 12.5V3.5ZM2.5 3.5H13.5V5.5H2.5V3.5ZM2.5 7H13.5V12.5H2.5V7Z"
      fill="currentColor"
    />
  </svg>
);

export const SettingsIcon = ({ size = 16, className }: { size?: number; className?: string }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M6.59 0.5H9.4L9.54 1.56C9.62 2.2 10.11 2.72 10.74 2.86C11.05 2.93 11.34 3.02 11.63 3.14C12.18 3.37 12.82 3.28 13.29 2.92L14.13 2.28L16 4.15L15.36 4.99C15 5.46 14.91 6.1 15.14 6.65C15.26 6.93 15.35 7.23 15.42 7.54C15.56 8.17 16.08 8.66 16.72 8.74L17.78 8.88V11.69L16.72 11.83C16.08 11.91 15.56 12.4 15.42 13.03C15.35 13.34 15.26 13.64 15.14 13.92C14.91 14.47 15 15.11 15.36 15.58L16 16.42L14.13 18.29L13.29 17.65C12.82 17.29 12.18 17.2 11.63 17.43C11.34 17.55 11.05 17.64 10.74 17.71C10.11 17.85 9.62 18.37 9.54 19.01L9.4 20.07H6.59L6.45 19.01C6.37 18.37 5.88 17.85 5.25 17.71C4.94 17.64 4.64 17.55 4.36 17.43C3.81 17.2 3.17 17.29 2.7 17.65L1.86 18.29L0 16.42L0.639 15.58C0.999 15.11 1.08 14.47 0.855 13.92C0.735 13.64 0.645 13.34 0.575 13.03C0.435 12.4 -0.0850001 11.91 -0.725 11.83L-1.78 11.69V8.88L-0.725 8.74C-0.0850001 8.66 0.435 8.17 0.575 7.54C0.645 7.23 0.735 6.93 0.855 6.65C1.08 6.1 0.999 5.46 0.639 4.99L0 4.15L1.86 2.28L2.7 2.92C3.17 3.28 3.81 3.37 4.36 3.14C4.64 3.02 4.94 2.93 5.25 2.86C5.88 2.72 6.37 2.2 6.45 1.56L6.59 0.5ZM8 13C10.76 13 13 10.76 13 8C13 5.24 10.76 3 8 3C5.24 3 3 5.24 3 8C3 10.76 5.24 13 8 13Z"
      fill="currentColor"
    />
    <path
      fillRule="evenodd"
